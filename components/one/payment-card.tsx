            ...
            <div className="rounded-xl bg-[var(--surface-inner)] border border-border/50 p-4 focus-within:border-[#d1fb00] focus-within:shadow-[0_0_15px_rgba(209,251,0,0.1)] transition-all">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <button
                    disabled
                    className="flex items-center gap-2.5 px-3 py-2 rounded-xl bg-white/5 border border-white/10 text-white transition-colors cursor-default"
                  >
...
function PaymentActionButton({
  ...
  if (!connected) {
    return (
      <button
        onClick={onConnect}
        className="w-full py-4 rounded-xl bg-[#050505] border border-[#d1fb00] text-[#d1fb00] font-bold tracking-widest uppercase hover:bg-[#d1fb00] hover:text-black transition-all cursor-pointer shadow-[0_0_15px_rgba(209,251,0,0.15)] hover:shadow-[0_0_25px_rgba(209,251,0,0.4)]"
      >
        Connect Wallet
      </button>
    );
  ...
  return (
    <button
      onClick={onSend}
      className="w-full py-4 rounded-xl bg-[#050505] border border-[#d1fb00] text-[#d1fb00] font-bold tracking-widest uppercase hover:bg-[#d1fb00] hover:text-black transition-all cursor-pointer shadow-[0_0_15px_rgba(209,251,0,0.15)] hover:shadow-[0_0_25px_rgba(209,251,0,0.4)] flex items-center justify-center gap-2"
    >
